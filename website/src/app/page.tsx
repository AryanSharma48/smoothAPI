    ...
    <div className="min-h-screen flex flex-col bg-[#0b0f19] text-slate-100 selection:bg-rose-500/30 selection:text-rose-200">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between border-b border-slate-800 bg-[#0b0f19]/80 backdrop-blur-md px-8 py-5">
        ...
        <div className="flex items-center space-x-6">
          <span className="hidden sm:inline-block text-sm font-mono px-3 py-1.5 bg-slate-800 rounded-md text-slate-400 border border-slate-700">
            v{process.env.NEXT_PUBLIC_TS_PKG_VERSION || "1.0.0"}
          </span>
          <a
            href="https://github.com/AryanSharma48/smoothAPI"
            target="_blank"
            rel="noreferrer"
            className="flex items-center space-x-2 bg-slate-800/80 hover:bg-slate-700 border border-slate-700 text-slate-300 hover:text-white text-base font-medium px-4 py-2 rounded-md transition-colors shadow-sm"
          >
            ...
            <span className="hidden sm:flex items-center">
              how about a star?
              <svg
                className="w-3.5 h-3.5 ml-1.5 opacity-70"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2.5}
      ...
      <div className="flex flex-1 max-w-7xl w-full mx-auto">
        ...
        <nav className="w-64 border-r border-slate-800/80 p-6 hidden lg:block sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto">
          <div className="space-y-8">
            <div>
              <h4 className="text-xs uppercase font-mono tracking-widest text-slate-500 mb-4">
                Documentation
              </h4>
        ...
        <main className="flex-1 py-10 px-6 md:px-12 max-w-4xl overflow-y-auto">
          ...
          >
            ...
            <p className="text-slate-300 leading-7 text-lg mb-6">
              A failing third-party API can bring down your entire application,
              leading to cascading service failures, degraded user experience,
              and lost revenue. How do you protect your systems and keep them
              resilient, even when downstream dependencies are completely
              unresponsive or failing?
            </p>
            <p className="text-slate-300 leading-7 text-lg mb-6">
              Enter <strong>SmoothAPI</strong>. SmoothAPI stops third-party API
              crashes from breaking your app. It wraps your HTTP calls with
              industry-standard resilience patterns, catches network errors
              instantly, spaces out retries so recovering servers can breathe,
              and serves safe backup data the millisecond a service goes
              completely dead.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
              <div className="border border-slate-800 bg-slate-900/30 p-5 rounded-xl">
                <h3 className="font-bold text-rose-400 mb-2">
                  TypeScript Native
                </h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Dual-environment fetch wrapper supporting Edge, Serverless,
                  and Node.js with built-in type inference.
                </p>
              </div>
              <div className="border border-slate-800 bg-slate-900/30 p-5 rounded-xl">
                <h3 className="font-bold text-rose-400 mb-2">Python Native</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Elegant function decorator supporting both sync and async
                  functions, integrating smoothly with requests and httpx.
                </p>
              </div>
            </div>
          </section>
          ...
          <section
            id="installation"
            ref={(el) => {
              sectionRefs.current["installation"] = el;
            }}
            className="mb-16 scroll-mt-24"
          >
            ...
            {codeLang === "ts" ? (
              <div className="space-y-4">
                <p className="text-slate-300 text-sm">
                  Create a custom resilient fetch instance and use it as a
...
const response = await fetchWithRetry('https://api.example.com/unstable');`}
              ...
              <div className="space-y-4">
                <p className="text-slate-300 text-sm">
                  Wrap any request functions using the `resilient_api` decorator
                  to catch exceptions and manage backoff:
                </p>
                <pre className="p-5 rounded-xl font-mono text-xs text-slate-300 overflow-x-auto leading-relaxed">
                  {`import requests
...
data = get_data()`}
          ...
          >
            ...
            <div className="space-y-8">
              <div className="border-l-4 border-rose-500 pl-4 py-1">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Retries transient failures with exponentially increasing
                  delays. Generates randomized &quot;jitter&quot; boundaries to
                  prevent client requests from hammering recovering endpoints in
                  sync (the &quot;thundering herd&quot; problem).
                </p>
              </div>
              ...
              <div className="border-l-4 border-rose-500 pl-4 py-1">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Tracks API health in isolated state machines. If a specific
                  domain reaches your failure threshold, the circuit trips to
                  `OPEN`, immediately blocking further connections and returning
                  fallback data. This prevents resource starvation and cascading
                  failures.
                </p>
              </div>
              ...
              <div className="border-l-4 border-rose-500 pl-4 py-1">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Support for `fallbackOnNonRetryable` /
                  `fallback_on_non_retryable`. Safely intercept non-retryable
                  client-side HTTP codes (like 404, 403, 400) and return custom
                  data, show browser alerts, or fire custom notification
                  callbacks instead of throwing app-breaking crashes.
                </p>
              </div>
            </div>
          </section>
          ...
          <section
            id="simulator"
            ref={(el) => {
              sectionRefs.current["simulator"] = el;
            }}
            className="mb-16 scroll-mt-24"
          >
            <h2 className="text-3xl font-bold mb-6">Interactive Simulator</h2>
            <p className="text-slate-300 mb-8">
              Test how the circuit breaker and fallback mechanisms work in
              real-time. Toggle network failures, dispatch requests, and monitor
              the circuit status well logs:
            </p>
            ...
            <div className="relative border border-slate-800 bg-[#0e1322]/40 backdrop-blur-sm rounded-2xl p-8 overflow-hidden text-center flex flex-col items-center justify-center min-h-[350px]">
              ...
              <p className="text-slate-400 text-sm max-w-md leading-relaxed mb-6">
                We are building a comprehensive real-time dashboard simulator.
                You will be able to inject customizable latency, simulate
                network timeouts, trigger random HTTP exceptions, and watch the
                circuit breaker dynamically transition states live.
              </p>
              ...
              <div className="w-full max-w-sm bg-[#070a13]/60 border border-slate-800/80 rounded-xl p-4 text-left font-mono text-[11px] text-slate-500 select-none">
                ...
                <div className="space-y-1.5">
                  <div>
                    [10:42:01] <span className="text-slate-500">INFO</span>{" "}
                    Initializing state machine...
                  </div>
                  <div>
                    [10:42:02] <span className="text-slate-500">INFO</span>{" "}
                    Target endpoint:{" "}
                    <span className="text-rose-500/60">
                      api.smooth.dev/v1/chaos
                    </span>
                  </div>
                  <div>
                    [10:42:03] <span className="text-rose-500/70">WARN</span>{" "}
                    Failure rate set to{" "}
                    <span className="text-amber-500/70">80%</span>. Ready to
                    probe.
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <p className="text-slate-300 mb-6">
              Customize the behavior of `SmoothAPI` using the following
              properties when initializing:
            </p>
                ...
                <tbody className="divide-y divide-slate-850">
                  <tr>
                    ...
                    <td className="py-3.5 px-4 text-slate-300">
                      Initial wait time before the first retry (ms in TS,
                      seconds in Python).
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="py-3.5 px-4 text-slate-300">
                      Time to wait (in ms) before entering HALF_OPEN probe
                      state.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-3.5 px-4 text-slate-300">
                      Object returned immediately on an OPEN circuit or client
                      error fallback.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-3.5 px-4 text-slate-300">
                      If true, returns fallbacks or mock responses on
                      non-retryable client codes (e.g. 404, 401).
                    </td>
                  </tr>
                  <tr>
                    <td className="py-3.5 px-4 font-mono font-bold text-rose-300">
                    ...
                    <td className="py-3.5 px-4 text-slate-300">
                      Custom callback fired when a client-error occurs. Disables
      ...
      <footer className="border-t border-slate-800 py-8 px-6 bg-[#070a13]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-slate-500 text-sm">
          ...
          <div className="flex space-x-6">
            <a
              href="https://www.npmjs.com/package/@codingaryan/smoothapi"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://pypi.org/project/smoothapi-py/"
              target="_blank"
              rel="noreferrer"
              className="hover:text-rose-500 transition-colors"
            >
